...
| macOS (Intel) | [`Son of Anton-macOS-x64.dmg`](https://github.com/SimonSaysGiveMeSmile/son-of-anton-public/releases/download/v2.2.9-mac/Son.of.Anton-macOS-x64.dmg) |
| macOS (Apple Silicon) | [`Son of Anton-macOS-arm64.dmg`](https://github.com/SimonSaysGiveMeSmile/son-of-anton-public/releases/download/v2.2.9-mac/Son.of.Anton-macOS-arm64.dmg) |
